...
function App() {
  ...
  return (
    <form onSubmit={handleSubmit(console.log)}>
      ...
      <h1>KNotify</h1>
      <TextField label="FirstName" color="primary"  {...register("firstName", { required: true })} placeholder="First name" />
      {errors.firstName && (<span style={{ color: errorColor }}>First name is required.</span>)}<br/><br/>

      <TextField label="LastName" color="primary" {...register("lastName", {  required: true  })} placeholder="Last name" />
      {errors.lastName && (<span style={{ color: errorColor }}> Last name is required </span> )}<br/><br/>
      
      <TextField label="Email" color="primary"  {...register("email", { required: true })} placeholder="Email" id="email" type="email" /><br/><br/>
      <TextField label="Password" color="primary"  {...register("password", { required: true })} placeholder="Password" id="password" type="password" /><br/><br/>
      <TextField label="Password" color="primary"  {...register("password", { required: true })} placeholder="Password" id="password" type="password" /><br/><br/>
     
     {/* <TextField label="Phone Number" inputProps={{ inputMode: 'numeric'}} /> */}

     <TextField label="Age" color="primary"  {...register('age', { pattern: /\d+/ })} />
      {errors.age && (<span style={{ color: errorColor }}>Please enter number for age. </span>)}<br/><br/>

      <TextField label="PhoneNumber"  color="primary" {...register('phone', { required: true })}  id="phone" type="number"/>
      ...
      <TextField label="Address" color="primary"  {...register("address", { required: true })} placeholder="Address" />
      ...
      <Button type="submit" fullWidth sx={{ mt:2, mb:8, justifyContent:"center"}} justifyContent="center">
      Register  </Button>     </Container> </form>              
